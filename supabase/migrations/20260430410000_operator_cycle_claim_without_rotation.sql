-- Remove rotação por janela e aplica trava por ciclo (captador) para evitar
-- que dois operadores peguem o mesmo ciclo ao mesmo tempo.
...
begin
  ...
  -- Seleciona o próximo ciclo e tenta adquirir trava transacional por captador.
  -- Isso impede atribuição concorrente do mesmo ciclo para operadores diferentes.
