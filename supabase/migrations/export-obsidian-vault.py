...
index_lines = [
    ...
    "",
    "## 📚 Wiki (documentação humana)",
    "",
    "- [[wiki/📚 Wiki LeadPayX|📚 Wiki LeadPayX]] — Índice da documentação",
    "- [[wiki/Sistema|Sistema]] — Visão geral, papéis, ciclo de conta, segurança, rotas",
    "- [[wiki/Fluxos|Fluxos]] — Passo-a-passo de cada fluxo ligado ao grafo",
    "- [[wiki/Funcoes Criticas|Funções Críticas]] — Hubs do grafo com mais dependências",
    "- [[wiki/Banco de Dados|Banco de Dados]] — Tabelas, campos, RPCs, audit_logs",
    "- [[wiki/Features Recentes|Features Recentes]] — Timeline, push admin, comissão por oferta, empréstimos",
    "",
    "## Grafo de código",
    "",
