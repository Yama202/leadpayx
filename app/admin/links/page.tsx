...
import type { AppSetting, RegistrationLink } from "@/lib/types";
...
export default async function AdminLinksPage() {
  ...
  return (
    <RoleBasedLayout
      description="Crie links rastreáveis para cadastro no app (código ref). Links de operação externa ficam em Links operação."
      profile={profile}
    ...
    >
      ...
      >
        ...
        />
        <input
          className="min-h-12 rounded-2xl border border-slate-200 px-4 uppercase dark:border-white/10 dark:bg-slate-950/70 dark:text-white"
          name="code"
          placeholder="CODIGO"
          required
        />
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                Expira:{" "}
                {link.expires_at ? new Date(link.expires_at).toLocaleString("pt-BR") : "sem expiração"}
              </p>
